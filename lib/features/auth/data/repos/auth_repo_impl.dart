...
class AuthRepository {
  ...
  Future<User?> updateUser(User data, BuildContext context) async {
    try {
      Response? response = await _apiServices.getPutApiResponse(AppUrls.updateUrl(userId: data.id), data.toMap(true));
      final baseResponseModel = baseResponseModelFromJson(response!.data);
